...
Функционал: 2.01. Планировние и лимитирование. Оперативные планы
...
Сценарий: 1.1. Проведение оперативного плана при выключенной константе "Автоматически актуализировать показатели бюджетов и проектов".
...
Сценарий 1.2. ОП (Лимиты) при включенной константе 'Актулизировать показатели бюджетов и резервов'
...
Сценарий 1.3. ОП (Планирование) при включенной константе 'Актулизировать показатели бюджетов и резервов'
...
Сценарий 1.4. ОП (Резервирование) при включенной константе 'Актулизировать показатели бюджетов и резервов'
