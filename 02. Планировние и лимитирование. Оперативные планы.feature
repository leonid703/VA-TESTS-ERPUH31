...
Сценарий 1.2. ОП (Лимиты) при включенной константе 'Актулизировать показатели бюджетов и резервов'
	...
	* Проверяем заполнение периода плана		
		...
		Тогда элемент формы с именем "ПериодОтчета" стал равен '1 квартал 2022 г.'
		Тогда элемент формы с именем "ПериодОтчетаОкончание" стал равен '4 квартал 2022 г.'
...
Сценарий 1.3. ОП (Планирование) при включенной константе 'Актулизировать показатели бюджетов и резервов'
	...
	* Заполняем период
		...
		И в поле с именем 'ПериодОтчета' я ввожу текст 'Май 2022 г.'
		И в поле с именем 'ПериодОтчетаОкончание' я ввожу текст 'Июль 2022 г.'		
