...
Функционал: 3.02. Казначейство. Создание распоряжений
...
Сценарий: 1. Инкассация ДС в банк
...
Сценарий: 2. Инкассация ДС из банка в кассу
...
Сценарий: 3. Перечисление ДС на другой счет
...
Сценарий: 4. Выдача ДС в другую кассу
